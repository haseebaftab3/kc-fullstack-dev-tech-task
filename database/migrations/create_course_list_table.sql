-- up migration for course_list table
CREATE TABLE IF NOT EXISTS `course_list` (
    `course_id` VARCHAR(255) PRIMARY KEY,
    `name` VARCHAR(500) NOT NULL,
    `description` TEXT NOT NULL,
    `preview` VARCHAR(2083),
    `category_id` VARCHAR(255) NOT NULL,
    `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    `updated_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
);

INSERT INTO `course_list` (`course_id`, `name`, `description`, `preview`, `category_id`)
VALUES 
    ("L373349028", "Diversity and Inclusion for a Better Business", 
    ...
    ("L373371072", "Leadership for Identity Diversity", 
    ...
    ("L373324687", "Applying Yourself to Diverse and Inclusive Leadership", 
    ...
    ("L373312762", "Finance and Accounting Basics for Nonfinancial Executives", 
    ...
    ("L373319845", "Financial Statements and Reporting for Nonfinancial Executives", 
    ...
    ("L373327593", "Financial Planning and Analysis for Nonfinancial Executives", 
    ...
    ("L373395597", "Valuation for Nonfinancial Executives", 
    ...
    ("L373337574", "Defining Cross-Cultural Leadership", 
